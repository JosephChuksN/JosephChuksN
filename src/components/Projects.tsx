...
const Projects:React.FC = () => {
  return (
    <div  className="flex flex-col  gap-10 md:w-3/5 mx-auto px-5 md:px-0 lg:pt-10 pt-12 translate-y-20 relative">
...
<div className="w-full h-[50vh]  flex lg:static relative ">
  <span className="flex w-full lg:hover:opacity-90 transition-all duration-300 ease-in-out delay-75  opacity-40   lg:w-[38rem] h-full rounded-md  bg-no-repeat bg-cover" style={{backgroundImage:`url(${linkpath})`}}></span>
