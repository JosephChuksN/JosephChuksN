...
const ProjectData:React.FC<props> = ({data}) => {
  ...
  return (
    <div className="w-full h-[100vh]  flex items-center justify-center ">
     <span className="flex w-full lg:opacity-90 transition-all duration-300 ease-in-out delay-75  opacity-40 border-[1px] border-[#F78D26]  lg:w-[38rem] h-full lg:h-[60vh]  rounded-md  bg-no-repeat bg-cover  " style={{backgroundImage:`url(${data.image})`}}></span>
     <div className="flex gap-10  lg:gap-3 flex-col relative h-full lg:h-[45%]  justify-center   w-full lg:w-[85%] left-0 lg:left-10 top-0  lg:top- bg-[#000000b5]  lg:bg-gradient-to-l from-[#0c0f11] to-[#0d1114] py-3 px-2  lg:px-10 shadow-xl shadow-[#00000082] rounded-md">
