...
useEffect(()=>{
  ...
  return (
    <div key={data.name} className="w-full h-full  flex flex-col lg:flex-row items-center justify-center lg:pb-5 p-1 pb-16 ">
     ...
     <span data-aos="zoom-in-down" ref={image} className={`flex  w-full h-[300px] lg:h-[65vh] rounded-l-md  bg-no-repeat bg-cover ${hover ? "scale-110": ""} `} style={{backgroundImage:`url(${data.image})`}}></span>
    
     
     <div data-aos="zoom-out-up"  className="flex gap-10  lg:gap-3 flex-col   h-full lg:h-[65vh]  justify-center   w-full  bg-[#000000b5]  lg:bg-gradient-to-l from-[#0c0f11] to-[#0d1114] py-3 px-2  lg:px-10  shadow-xl shadow-[#00000082] rounded-r-md">
