...
useEffect(()=>{
  ...
  return (
    ...
    <Image  priority={true}  data-aos="zoom-in-down" width={500} height={500} src={data.image} alt='project image'  />
     ...
     <div data-aos="zoom-out-up"  className="flex gap-3   flex-col   h-full lg:h-[55vh]  justify-center w-full  bg-[#000000b5]  lg:bg-gradient-to-l from-[#0c0f11] to-[#0d1114] py-3  px-2  lg:px-8  shadow-xl shadow-[#00000082] rounded-r-md">
